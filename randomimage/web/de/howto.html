...
<p>Wenn Sie die App zum ersten Mal öffnen, wird zunächst Ihr Telefon nach Bildverzeichnissen durchsucht
	(einschließlich SD-Karte), und es wird eine erste Bildliste erstellt, die alle diese Verzeichnisse enthält. Diese Liste
	können Sie dann verwenden, um zufällige Bilder Ihres Telefons anzuschauen. Anschließend können Sie die Bildliste
	ändern, wenn Sie nur bestimmte Fotoverzeichnisse auf Ihrem Telefon berücksichtigen wollen.</p>

<h4>Öffnen der Konfigurationsseite</h4>

<p>Um Ihre Bildliste zu konfigurieren, müssen Sie generell die Konfigurationsseite für die Bildliste öffnen. Dies
	können Sie auf folgende Arten tun:</p>

<ul>
	<li>Durch langes Drücken auf ein Bild, während Sie es sehen, und anschließendes Drücken von &bdquo;Bildliste
		anzeigen&ldquo;.</li>
	<li>Von der <a href="#mainConfiguration">Hauptkonfigurationsseite</a>, in der all Ihre Bildlisten angezeigt
		werden.
	</li>
...
<ul>
	<li>Wenn Sie das Startseiten-Symbol drücken, wird die App ein zufälliges Bild aus Ihrer Zufallsbildliste im
		Vollbild anzeigen. Wenn Sie mehrere Bilderlisten konfiguriert haben, werden Sie zunächst aufgefordert, die Bilderliste
	...
	<li>Wenn Sie wissen wollen, wo die Bilddatei liegt, drücken Sie etwas länger auf das Bild. Von hier aus haben Sie
...
<ul>
	<li><b>Mini-Widget:</b> Dieses Widget verhält sich wie der Startseitensymbol, solange Sie nur eine Bildliste
		haben. Wenn Sie mehrere Bildlisten konfiguriert haben, dann ruft man mit dem Mini-Widget ein zufälliges Bild einer
		bestimmten Bildliste auf.</li>
	...
	<li><b>Zufallsbilderstapel:</b> Dieses Widget legt die Bilder Ihrer Liste in zufälliger Reihenfolge als
		Kartenstapel oder als scrollbare Liste auf dem Home-Bildschirm. Sie können sich von einem Bild zum nächsten bewegen.</li>
</ul>
