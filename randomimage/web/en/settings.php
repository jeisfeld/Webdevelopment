...
<p>You can purchase the app &ldquo;Random Image Pro&rdquo; that enables the use of more than three image lists in
	the app.</p>
...
<ul>
	...
	<li><b>Action when flipping:</b> Here you can specify what happens when flipping away an image.
		<ul>
			...
			<li><b>Allow to go back, avoid repetitions:</b> Analogous, but when selecting the next random image repetitions
				are avoided</li>
...
<ul>
	<li><b>Folder selection:</b> Here you can select between three different mechanisms to add images and folders:
		<ul>
			<li><b>List of image folders (default):</b> Here you get the list of all image folders displayed and can select
				from this list. This is the easiest option.</li>
			<li><b>File browser:</b> Here you can select your image folders in a file browser.</li>
			<li><b>Gallery:</b> Here you can select the image folder via the Gallery app. This may be helpful if you find
				your images easiest in the gallery.</li>
		</ul></li>
	<li><b>Search image folders:</b> Here you can trigger a re-scan of the device memory for image folders.</li>
	<li><b>Reset backup folder (Android 10 and higher):</b> Here you can undo the selection of the backup folder so
		that it will be queried again the next time you backup / restore.</li>
	...
	<li><b>Notify on list change:</b> Here you can decide to display notifications in case of addind/removing images
		or folders to some image list.</li>
	<li><b>Use regexp filter:</b> This allows to globally filter out certain lists or folders from the display.</li>
	<li><b>Display all info messages:</b> There are various info messages in the app which you may disable by pressing
		the button &ldquo;Do not show again&rdquo;. The button &ldquo;Display all info messages&rdquo; re-enables all these
		messages.</li>
	<li><b>Do not display info messages:</b> This disables all kinds of info messages which otherwise need to be
		switched off individually. This is helpful for experienced users who install the app on a new device.</li>
</ul>
...
<ul>
	...
	<li><b>View as list:</b> If this is selected, then the Random Image Deck is displayed as a scrollable list instead
		of a deck.</li>
	...
	<li><b>Use default settings:</b> Here you can specify if, when viewing the image in detail, the default settings
		should be used, or if the settings &ldquo;Image scaling&rdquo;, &ldquo;Background color&rdquo;, &ldquo;Action when
...
<ul>
	...
	<li><b>Notification variability:</b> Here you can decide if notifications come in rather equal time intervals or
		in bigger variation.</li>
	<li><b>Start hour for notifications, End hour for notifications:</b> Here you can select a time window in which
		the notifications may come.</li>
