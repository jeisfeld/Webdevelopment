...
<p>This app displays random images from image lists that you configure. Therefore, you first have to configure an
	image list before you can enjoy the display of random images.</p>

<h3>Setup of the image list</h3>

<h4>First steps</h4>

<p>When you open the app for the first time, the app will first search for image folders on your device (including
	SD card), and an image list will be created that contains all these image folders. You can then use this list in order
	to view random images from your device. Afterwards you can change the image list, if you want to see only certain image
	folders from your device.</p>

<h4>Opening the configuration page</h4>

<p>Generally, in order to configure your image list, you have to open the configuration page of the list. You can
	access this page in the following ways:</p>
...
<ul>
	...
	<li>Alternatively, you may display a photo in the gallery app and send the image from there to the Random Image
		app, or you may select multiple photos in the gallery app and send them to the Random Image app.</li>
</ul>
...
<p>Included lists are displayed as a blue folder. If you make a long click on such a list, you may adjust how
	frequent images from this nested list are taken. In this way you may increase the display frequency of pictures from
	small lists. The same you may do for folders.</p>
...
<ul>
	<li>If you press the launcher icon, the app will start displaying a random image from your random image list on
		full screen. If you have configured multiple image lists, you are first asked to select the image list from which you
		want to display images.</li>
	...
	<li>If you want to know the file location of this image, make a long press on the image. From here, you may also
		do other things:
		<ul>
...
<ul>
	<li><b>Mini Widget:</b> This widget behaves like the launcher, as long as you have only one image list. If you
		have multiple image lists configured, then the Mini Widget allows to display a random image of a specific image list.</li>
	<li><b>Random Image Frame:</b> This widget places one of the images of your list on the home screen and changes it
		in regular intervals. You have various configuration possibilities.</li>
...
<p>If you tap on the Random Image Frame or the Random Image Deck, then you can see the displayed photo in detail.
	From here, you may flip the image away in order to see other images from the same list.</p>
