...
<body>
	<h2>Diagnóstico ocular - Información general</h2>
	...
	<ul>
		...
		<li>Visualización de dos fotos oculares en paralelo (con la posibilidad de cambio de tamaño individual), con el
			fin de compararlos (por ejemplo, derecha-izquierda comparación, la comparación antes-después, comparación de personas
			diferentes, o comparación con una topografía del iris).</li>
		<li>Cambio de brillo y contraste de la foto durante la visualización, y superposición con una topografía del
			iris.</li>
	...
	<p>La aplicación espera nuevas fotos de los ojos en una carpeta de entrada. Esta está preconfigurada como la
		carpeta de destino de la aplicación Eye-Fi o como la carpeta predeterminada de la cámara, pero se puede cambiarlo por
		medio de la configuración.</p>
	...
	<p>Como alternativa, puede seleccionar dos fotos en un explorador de archivos o en una aplicación de fotos, y
		enviar estas fotos a la aplicación Diagnóstico del ojo. A continuación, puede organizar estas fotos en la aplicación.
		En este caso, las fotos no se eliminarán de su ubicación anterior.</p>
	...
	<p>Este es el objetivo principal de la aplicación, pero requiere de las fotos para ser organizado por medio del
		paso 1.</p>

	<p>En esta actividad, usted puede</p>
	<ul>
		<li>Mostrar una de las fotos en detalle. Aquí también se puede cambiar el brillo y el contraste de la foto,
			muestra iris topografías como superposición, o escribir comentario a una foto.</li>
	...
	<p>La aplicación graba información (como posición del iris o comentarios) directamente en los archivos de imagen
		JPG. Esto tiene la ventaja de que toda la información es todavía disponible si copia las imágenes de un dispositivo a
		otro. En parte, la información como los comentarios será aún disponible en MS Windows.</p>

	<p>Sin embargo, este tipo de almacenamiento impone un pequeño riesgo. Puede suceder que en algunos dispositivos, o
		para los cuadros del algunas cámaras, el almacenamiento de información en el JPG falla, o posiblemente hasta destruye
		el archivo JPG. Por lo tanto, es recomendado que mantenga copias de seguridad de sus archivos JPG, al menos cuando se
