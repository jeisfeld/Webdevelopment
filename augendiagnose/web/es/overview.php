...
<ul>
	...
	<li>También puede guardar la información en las fotos, por ejemplo el brillo y comentarios. Para ser capaz de almacenar
		información y usar la plena funcionalidad de la aplicación, las fotos tienen que tener formato JPG.</li>
</ul>
...
<p>En el actividad &laquo;Organizar nuevas fotos&raquo;, puede asignar nuevas fotos de los ojos de la carpeta de entrada
	a una persona y una fecha y prepararlos en esta manera para la aplicación. De este modo, las fotos serán renombradas y
	trasladadas a la carpeta de la aplicación.</p>
...
<p>
	...
	<a href="https://augendiagnose-app.de/?lang=es&page=windowsapp" target="_top">https://augendiagnose-app.de/?page=windowsapp</a>
	.
</p>
...
<ul>
	...
	<li>En las esquinas en la parte superior se encuentra la pantalla del derecho y del izquierdo ojo. La marca roja indica
		que ojo está previsto para la próxima foto. Pulsando sobre una de estas áreas se puede cambiar el lado.</li>
	<li>En la pantalla de la cámara hay un gran círculo. Este círculo indica el lugar donde el iris debe aparecer en la
		foto.</li>
	<li>En la parte inferior izquierda, hay un botón con un círculo y el texto &laquo;zoom&raquo;. Aquí se puede establecer
		el zoom de la cámara y seleccionar qué tan grande el iris debe estar en la foto.</li>
	<li>Arriba, hay un botón con el texto &laquo;MACRO&raquo; o &laquo;AUTO&raquo;. Aquí usted puede seleccionar el modo de
		enfoque de la cámara. Para primeros planos, el modo macro es normalmente una buena opción.</li>
...
<p>
	Hay una aplicación de acompañamiento de Windows que se puede utilizar para ver las fotos que han sido organizada con
	esta aplicación. Para obtener más información, consulte
	<a href="https://augendiagnose-app.de/?app=miniris&lang=es&page=windowsapp" target="_top">https://augendiagnose-app.de/?app=miniris&page=windowsapp</a>
	.
</p>
