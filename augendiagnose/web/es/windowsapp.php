...
<p>La aplicación de Windows sólo se diseñó como complemento a la aplicación para Android. Permite menos funciones que la
	aplicación para Android. En particular, no permite organizar nuevas fotos y establecer la posición de las
...
<p>
	...
	Android con una carpeta de fotos oculares correspondiente en el ordenador de Windows. Esta carpeta debe configurarse en
	las ajustes.<br> Una posible forma de sincronización es instalar una aplicación WebDAV en su dispositivo Android e
...
<ul>
	...
	<li><b>Color predeterminado de superposiciones:</b> Aquí puede definir el color predeterminado para los superposiciones
		de topografías del iris.</li>
