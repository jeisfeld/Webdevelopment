...
if (isAugendiagnose ()) {
	?>
<h2><?php if (!array_key_exists("createHtmlString", $_GET)) {?><span class="mobile"><?=$appname?> - </span><?php }?>Organisation der Fotos</h2>
...
<p>Mit dem Button &bdquo;OK&ldquo; können Sie das gewählte Paar Augenfotos in das Augenfoto-Verzeichnis verschieben. Die
	Fotos werden zur angegebenen Person und dem angegebenen Datum zugeordnet und stehen dem Programm anschließend zur
	Verfügung.</p>

<p>Durch das Antippen des Fotopaares können Sie die beiden Fotos im Detail ansehen. (Siehe auch: &bdquo;Fotos
	ansehen&ldquo;)</p>
<?PHP
}
?>
