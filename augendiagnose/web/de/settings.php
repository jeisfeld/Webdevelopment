...
<table width="100%" border="1">
	...
	<tr>
		...
		<td width="70%" valign="top">Hier kann eingestellt werden, ob das letzte Foto das rechte oder das linke Auge ist.
			Standardmäßig ist hier das linke Auge gewählt (unter der Annahme, dass Sie zuerst das rechte, und dann das linke Auge
			fotografiert haben).</td>
	</tr>
</table>
<?PHP
}
	...
	<tr>
		...
		<td width="70%" valign="top"><p>Dies ist das Verzeichnis, in dem die App die Augenfotos verwaltet. Dieses muss
			...
			<p>Sie können hier ein Verzeichnis wahlweise im Gerätespeicher oder auf der SD-Karte wählen. Unter Android 4.4
				...
				Android 5 müssen Sie bei der Auswahl eines Verzeichnisses der SD-Karte zunächst der App den Zugriff auf die SD-Karte
				gewähren (mittels des Storage Access Frameworks von Android).</p></td>
	</tr>
	<tr>
		<td width="30%" valign="top">Maximale Bitmap-Größe</td>
		<td width="70%" valign="top">Dies ist die Größe, auf die Fotos zur Anzeige herunterskaliert werden. Dies ist nötig, um
			Speicherplatz zu sparen. Als Standard ist hier 2048 eingestellt. Auf speicherarmen Geräten muss evtl. ein kleinerer
			Wert (z.B. 1024) konfiguriert werden. Zu große Werte können zu Abstürzen führen.</td>
	</tr>
	<tr>
		<td width="30%" valign="top">Anzeige in voller Auflösung</td>
		<td width="70%" valign="top">Hier können Sie festlegen, unter welchen Umständen das Foto in voller Auflösung angezeigt
			wird. Dies erlaubt es, mehr Details auf dem Foto zu sehen, aber es verbraucht Speicher und Rechenzeit.
...
if (isMiniris ()) {
	?>
		...
		<td width="70%" valign="top">Hier kann eingestellt werden, welches Auge zuerst fotografiert werden soll. Standardmäßig
			ist hier das rechte Auge gewählt.</td>
	</tr>
<?PHP
}
?>
	...
	<tr>
		<td width="30%" valign="top">Frontkamera verwenden</td>
		<td width="70%" valign="top">Hier können Sie festlegen, dass Sie zum Fotografieren die vordere Kamera verwenden
			wollen. Normalerweise wird die hintere Kamera verwendet.</td>
	</tr>
	<tr>
		<td width="30%" valign="top">Link zur Kamera-App anzeigen</td>
		<td width="70%" valign="top">Hier können Sie festlegen, ob der Knopf zum Aufnehmen von Fotos mit der Systemkamera-App
