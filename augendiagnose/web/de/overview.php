...
if (isAugendiagnose ()) {
	...
	Diese Applikation ist noch im Beta-Stadium - weitere Funktionalitäten sind geplant. Wünsche für weitere Funktionen
...
<?PHP
	...
	<ul>
		...
		<li>Links unten befindet sich ein Blitz-Knopf. Hier können Sie einstellen, ob Sie das Blitzlicht des Gerätes benutzen
			wollen.</li>
		<li>Darüber befindet sich ein Knopf mit einem Kreis. Hier können Sie auswählen, wie groß die Iris auf dem Foto sein
			sollte.</li>
	</ul>
