...
if (isAugendiagnose ()) {
	?>
<h2><?php if (!array_key_exists("createHtmlString", $_GET)) {?><span class="mobile"><?=$appname?> - </span><?php }?>Organize the photos</h2>
...
<p>At &ldquo;Select Date&rdquo; you can select the date on which the photos are listed. Typically this is the capture
	date of the photos, which is preselected. However, you may select a different date. This is necessary in particular, if
	you want to keep more than one eye pair of a person from one date - the app allows only one photo pair per day and
	person.</p>
