...
<body>
	...
	<p>With the button &ldquo;Other Photos&rdquo;, you can select two different photos from the input folder, by clicking
	...
	<p>At &ldquo;Select Date&rdquo; you can select the date on which the photos are listed. Typically this is the capture
		date of the photos, which is preselected. However, you may select a different date. This is necessary in particular,
		if you want to keep more than one eye pair of a person from one date - the app allows only one photo pair per day and
		person.</p>
