	...
	<table width="100%" border="1">
		<tr>
			...
			<td width="70%" valign="top">
				...
				<p>Bagagem com relação à aplicação Eye-Fi: normalmente, a câmera do celular não é suficiente para tirar fotos de
					olho em alta qualidade. Uma abordagem mais prática é usar uma câmera externa com SD Eye-Fi, que transfere as fotos
					via WLAN no dispositivo celular.</p>
			</td>
		</tr>
		<tr>
...
?>
	...
	<table width="100%" border="1">
		<tr>
			...
			<td width="70%" valign="top"><p>Esta é a pasta na qual o aplicativo gerencia as fotos dos olhos. Normalmente, você
					não precisa alterar isso. A partir daqui, você pode copiar as fotos para outros dispositivos.</p>
		...
		<tr>
			...
			<td width="70%" valign="top">Este é o tamanho em que as fotos são reduzidas antes de serem exibidas. Isso é
				necessário para salvar a memória do dispositivo. O valor padrão é 2048. Em dispositivos com pouca memória, pode ser
				necessário definir um valor mais baixo (por exemplo, 1024). valores muito grandes podem bloquear o aplicativo.</td>
		</tr>
		<tr>
			...
			<td width="70%" valign="top">Aqui você pode decidir sob quais circunstâncias a foto é mostrada em alta resolução, o
				...
				<ul>
					...
					<li><b>Carregar apenas se solicitado</b> O aplicativo não mostra a imagem em alta resolução. Isso requer menos
						...
						src="../drawable/ic_clarity.png" /> permite visualizar os detalhes atuais da imagem em resolução total.</li>
				</ul>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="70%" valign="top">Aqui você pode selecionar se o aplicativo deve tentar encontrar automaticamente a
				posição da íris e da pupila nas fotos dos olhos. Normalmente, isso simplifica o posicionamento das sobreposições, mas
				exige muitos recursos do telefone, e o resultado pode estar incorreto.</td>
		</tr>
	</table>
...
?>
		...
		<tr>
			...
			<td width="70%" valign="top">Aqui você pode especificar se deseja mostrar o botão para tirar fotos com o aplicativo
				da câmera do sistema.</td>
		</tr>
		<tr>
	...
	<p>Esta página permite definir quais topografias de íris podem ser exibidas pressionando os botões de sobreposição.
		Isso também pode ser feito enquanto visualiza as fotos, fazendo uma pressão longa em um botão de sobreposição.</p>
