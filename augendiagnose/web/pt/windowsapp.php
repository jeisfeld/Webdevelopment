...
<html>
<head>
<title><?=$appname?> - O aplicativo para o Windows</title>
...
<body>
	...
	<p>O aplicativo do Windows foi projetado apenas como um complemento para o aplicativo Android. Permite menos funções do
		que a aplicação Android. Em particular, não permite organizar novas fotos e estabelecer a posição das sobreposições.
		No entanto, permite mostrar fotos e sobreposições e editar o comentário.</p>

	<p>
		Para usar o aplicativo do Windows, você precisa sincronizar a pasta de fotos do olho do seu dispositivo Android com
		uma pasta de foto de olho correspondente no computador Windows. Esta pasta deve ser configurada nas configurações.<br>
		Uma maneira possível de sincronizar é instalar um aplicativo WebDAV no seu dispositivo Android e instalar algum
		aplicativo de sincronização no seu computador Windows (como o FreeFileSync). Você pode então configurar os aplicativos
		de sincronização de forma que acesse seu dispositivo Android sem fio através do WebDAV.
	</p>
	...
	<ul>
		...
		<li><b>Visualizar&rarr;Barra de sobreposição:</b> Mostra ou oculta o painel para exibir sobreposições ou alterar o brilho
			/ contraste</li>
