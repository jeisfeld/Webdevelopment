...
<html>
<head>
<title><?=$appname?> - Visualizar fotos</title>
...
<body>
	...
	<ul>
		...
		<li>Mostrar duas fotos de pessoas diferentes: selecione uma foto dessa pessoa (pressione e segure) e selecione uma
			foto de uma pessoa diferente.</li>
	</ul>
	...
	<ul>
		...
		<li>Adaptação do tamanho da pupila das sobreposições (botão <img src="../drawable/ic_btn_pupil_0.png"
			class="frameless" />). Aqui você pode manter a pupila centrado (<img src="../drawable/ic_btn_pupil_1.png"
			class="frameless" />) ou movê-lo livremente (<img src="../drawable/ic_btn_pupil_2.png" class="frameless" />).
		</li>
		...
		<li>Alterar o comentário da foto (por meio do botão &laquo;documento&raquo; <img src="../drawable/ic_comment.png" />
			na barra de ação)
		</li>
	</ul>
