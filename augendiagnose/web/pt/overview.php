...
<html>
<head>
<title><?=$appname?> - Informações Gerais</title>
...
if (isAugendiagnose ()) {
	...
	<ul>
		<li>Mostrar uma das fotos em detalhes. Aqui você também pode alterar o brilho e o contraste da foto, exibir
			topografias de íris como sobreposição ou escrever comentários em uma foto.</li>
...
<?PHP
	...
	<ul>
		<li>No lado direito no meio está o botão para capturar a foto. Depois de capturar uma foto, você pode decidir se
			deseja manter a foto ou se deseja descartá-la e capturar a foto novamente.</li>
...
?>
	...
	<p>
		...
		<a href="https://support.google.com/analytics/answer/6004245?hl=es" target="_blank">Política de Privacidade do Google
			Analytics </a>
		para mais detalhes.
	</p>
</body>
